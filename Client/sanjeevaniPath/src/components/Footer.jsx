    ...
    <footer className="qh-footer">
      <div className="qh-container">
        <div className="qh-footer-grid">
          <div className="qh-brand">
            ...
            <p className="qh-footer-text">
              Access healthcare anytime, anywhere. Our telemedicine platform connects
              patients with qualified healthcare providers for virtual consultations.
            </p>
          </div>
          ...
          <div className="qh-links-group">
            ...
            <div>
              ...
              <ul className="qh-footer-list">
                <li><a href="/privacy" className="qh-footer-link">Privacy Policy</a></li>
                <li><a href="/terms" className="qh-footer-link">Terms of Service</a></li>
                <li><a href="/accessibility" className="qh-footer-link">Accessibility</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <address className="qh-footer-address">
                ...
                <p className="qh-footer-contact">Email: info@SanjeevaniPath.com</p>
                <p>Phone: 123456789</p>
              </address>
            </div>
          </div>
        ...
        <div className="qh-footer-bottom">
          <p>© {new Date().getFullYear()} SanjeevaniPath. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
