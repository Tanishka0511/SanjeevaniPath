  ...
  return(
    ...
    <div className="login-container">
      <div className="login-box">
        ...
        <button className="login-button black" onClick={handleLoginClickDoc} >Register</button>
         <p className="alt-text">
          Already have an account? <a href="#" className="green-link"><Link to="/login"> Login </Link></a>
        </p>
      </div>
      <div className="login-box">
        ...
        <button className="login-button white" onClick={handleLoginClick}>Register</button>
       <p className="alt-text">
          Already have an account? <a href="#" className="green-link"><Link to="/login"> Login </Link></a>
        </p>
      </div>
